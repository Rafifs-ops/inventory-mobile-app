    ...
    <div class="min-h-screen bg-gray-50 text-slate-800 p-6 flex flex-col items-center py-12">
        ...
        <div class="w-full max-w-2xl">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Dashboard & Laporan</h2>
                    <p class="text-sm text-slate-500 mt-1">Ringkasan performa finansial dan pergerakan produk</p>
                </div>
                ...
                <div class="w-full sm:w-auto">
                    ...
                    <input type="month" v-model="filterBulan" @change="muatData"
                        class="w-full sm:w-48 p-2.5 text-sm text-slate-800 bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-shadow">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                ...
                <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-slate-500 mb-1">Laba Bersih</p>
            ...
            <button @click="eksporLabaRugi"
                class="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
